        ...
        with(binding){
            SubmitButton.setOnClickListener {
                if (InputUsername.text.equals("")){
                    Toast.makeText(requireActivity(), "Mohon masukan username", Toast.LENGTH_SHORT).show()
                ...
                if (InputFullname.text.equals("")){
                    Toast.makeText(requireActivity(), "Mohon masukan nama lengkap", Toast.LENGTH_SHORT).show()
                    return@setOnClickListener
                }
                ...
                editor.putString("username", InputUsername.text.toString())
                editor.putString("password", InputPassword.text.toString())
                editor.putString("email", InputEmail.text.toString())
                editor.putString("fullname", InputFullname.text.toString())
